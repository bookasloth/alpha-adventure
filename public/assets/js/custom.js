(function ($) {
  ...
  $(document).on("click", ".sidebar-button, .mobile-menu-btn", function (e) {
    e.stopPropagation();
  ...
  var swiper = new Swiper(".home1-trip-slider", {
    ...
    navigation: {
      nextEl: ".home1-trip-slider .swiper-button-next",
      prevEl: ".home1-trip-slider .swiper-button-prev",
    },
    breakpoints: {
      280: {
        slidesPerView: 1,
  ...
  // Home2 Package Slider
  var swiper = new Swiper(".home2-package-slider", {
    slidesPerView: 1,
    speed: 1500,
    spaceBetween: 24,
    autoplay: {
